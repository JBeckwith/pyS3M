...
class TestCoordinateFunctions:
    ...
    def test_xyz_coordinate_functions(self):
        ...
        functions_to_test = [
            'to_xyz', 'from_xyz', 'transform_xyz', 
            'rotate_coordinates', 'translate_coordinates'
        ]
...
class TestImageProcessingFunctions:
    ...
    def test_image_statistics_functions(self):
        ...
        functions_to_test = [
            'calculate_noise', 'estimate_background', 'image_moments',
            'center_of_mass', 'image_entropy'
        ]
...
class TestPicksFunctions:
    ...
    def test_picks_conversion_functions(self, sample_picks):
        ...
        functions_to_test = [
            'picks_to_array', 'array_to_picks', 'picks_to_dict',
            'dict_to_picks', 'format_picks'
        ]
    ...
    def test_picks_filtering_functions(self, sample_picks):
        ...
        functions_to_test = [
            'filter_picks', 'remove_duplicates', 'picks_in_region',
            'picks_by_frame', 'picks_by_photons'
        ]
    ...
    def test_picks_analysis_functions(self, sample_picks):
        ...
        functions_to_test = [
            'calculate_density', 'nearest_neighbor_distance',
            'clustering_analysis', 'spatial_correlation'
        ]
...
class TestIOFunctions:
    ...
    def test_path_functions(self):
        ...
        functions_to_test = [
            'get_filename', 'get_extension', 'split_path',
            'join_path', 'ensure_directory'
        ]
    ...
    def test_file_operations(self):
        ...
        functions_to_test = [
            'safe_save', 'backup_file', 'temp_filename',
            'atomic_write', 'file_exists_check'
        ]
...
class TestMathUtilities:
    ...
    def test_statistics_functions(self):
        ...
        functions_to_test = [
            'median_filter', 'robust_mean', 'percentile_filter',
            'mad_std', 'trimmed_mean'
        ]
    ...
    def test_fitting_utilities(self):
        ...
        functions_to_test = [
            'fit_gaussian', 'fit_polynomial', 'linear_regression',
            'exponential_fit', 'robust_fit'
        ]
...
class TestErrorHandling:
    ...
    def test_error_handling_with_invalid_data(self):
        ...
        for func_name in test_functions[:5]:  # Test only first 5 to avoid excessive testing
            func = getattr(lib, func_name)
            
            for bad_input in problematic_inputs[:2]:  # Test only first 2 problematic inputs
                try:
