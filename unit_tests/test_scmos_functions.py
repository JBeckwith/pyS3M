...
class TestsCMOSFunctions:
        ...
        for method in demosaic_methods:
            try:
                demosaiced = scmos_functions.demosaic_images(
                    sample_bayer_image, method=method
                )
    ...
    @pytest.mark.unit
    def test_camera_calibration_application(
        self, scmos_functions, sample_bayer_image, sample_camera_params
    ):
    ...
    @pytest.mark.integration
    def test_integration_with_camera_calibration(
        self, scmos_functions, sample_camera_params
    ):
        ...
        synthetic_image = (
            synthetic_image / sample_camera_params["gain"][:height, :width]
        )
        synthetic_image = (
            synthetic_image + sample_camera_params["offset"][:height, :width]
        )
