...
class TestPSFFunctions:
    ...
    def test_camera_image_generation_single_spot(
        self, psf_functions, sample_camera_params
    ):
        ...
        try:
            image = psf_functions.gen_camera_image_stack(
                ...
                spot_photons,
                sigma,
                sample_camera_params["height"],
                sample_camera_params["width"],
    ...
    @pytest.mark.integration
    def test_camera_image_generation_multiple_spots(
        self, psf_functions, sample_camera_params
    ):
