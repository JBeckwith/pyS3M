#!/usr/bin/env python3
"""
Interactive Threshold Tuner for Nile Red Analysis - 20250919
Bacteria with Sina experiments

This script helps determine optimal spot detection parameters (pfa, sigma, fraction_true)
for spot detection in Nile Red stained bacteria datasets. It interactively loads 3 test frames
(1, 10, 20) from each folder in the Nile Red analysis workflow, displays detection results
in a column layout, and saves the optimized parameters for use by 20250919_NileRedAnalysis.sh.

Usage:
    python superres_notebooks/20250919_NileRedAnalysisTuner.py

Output:
    20250919_nile_red_threshold_parameters.txt - Parameter file for 20250919_NileRedAnalysis.sh
...
class NileRedThresholdTuner:
    ...
    def save_threshold_parameters(self, output_file: str = "20250919_nile_red_threshold_parameters.txt"):
        """Save threshold parameters to file for 20250919_NileRedAnalysis.sh"""
        ...
        with open(output_path, "w") as f:
            f.write("# Threshold parameters for Nile Red Analysis - 20250919\n")
            f.write("# Generated by 20250919_NileRedAnalysisTuner.py\n")
    ...
    def run(self):
        ...
        print("=" * 80)
        print("Nile Red Interactive Threshold Tuner - 20250919")
        print("Bacteria with Sina experiments")
        print("=" * 80)
        print("This tool helps determine optimal spot detection parameters")
        print("for Nile Red stained bacteria in your analysis workflow.\n")
