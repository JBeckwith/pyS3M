...
class extract_SMs(HDBSCANMixin, DBSCANMixin, LinkedMixin, BatchMixin):
    ...
    # ------------------------------------------------------------------
    # Clustering methods (HDBSCAN, DBSCAN, linked, spectral LAP, batch)
    # are provided by the mixin base classes:
    #   HDBSCANMixin, DBSCANMixin, LinkedMixin, BatchMixin
    # See src/clustering/ for implementations.
    # ------------------------------------------------------------------
