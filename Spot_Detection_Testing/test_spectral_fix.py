...
try:
    ...
    wavelength, dye_spectrum, absolute_QYs, avg_wavelength, dye_efficiency = spectral_data
    
    print(f"✓ Spectral data loaded successfully")
    print(f"  Wavelength range: {wavelength.min():.0f}-{wavelength.max():.0f} nm ({len(wavelength)} points)")
