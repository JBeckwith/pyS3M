...
| 2.1 | Split `DriftCorrectionFunctions.py` into `drift_correction/` submodule | DriftCorrection + callers | 2 days |
| 2.2 | Extract `FilteringCriteria` dataclass; reduce `extract_single_molecules_*` signatures | SM_extractionfunctions | 1 day |
