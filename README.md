...
The package "pyBayerSLML" (written in support of ongoing work) is a set of python classes that can be run from scripts, interactive notebooks and so on to analyse multicolour microscopy data. 
