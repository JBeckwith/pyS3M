...
images), and saves the optimized parameters for use by 20250930_NileRedAnalysis.sh.
...
class NileRedThresholdTuner:
    ...
    def __init__(self):
        ...
        self.default_ever_window = 100  # Default EVER window size in frames (typical: 50-200)
